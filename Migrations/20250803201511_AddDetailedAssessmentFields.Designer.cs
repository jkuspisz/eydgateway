...
namespace EYDGateway.Migrations
{
    ...
    [Migration("20250803201511_AddDetailedAssessmentFields")]
    partial class AddDetailedAssessmentFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EYDGateway.Models.PortfolioReflection", b =>
                {
                    ...
                    b.Property<string>("FutureActions")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("EYDGateway.Models.SLE", b =>
                {
                    ...
                    b.Property<string>("AreasOfStrength")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
                    ...
                    b.Property<bool?>("RecommendForProgression")
                        .HasColumnType("boolean");
